...
public class RoutingEngineAstar {
    ...
    private final Set<String> excludedStopIds;
    ...
    public static void main(String[] args) {
        ...
        double sourceLat = 47.533834; //source point
        double sourceLon = 18.862378; //source point 2
        double destLat = 47.40806; // destination point
        double destLon = 19.18806; // destination point 2
    ...
    public RoutingEngineAstar(DBConnectionManager dbManager) {
        this(dbManager, Collections.emptySet());
    }

    public RoutingEngineAstar(DBConnectionManager dbManager, Set<String> excludedStopIds) {
        this.dbManager = dbManager;
        this.excludedStopIds = excludedStopIds;
    ...
    public List<RouteStep> findRoute(double sourceLat, double sourceLon,
        ...
        // THIS WILL NOW CORRECTLY TRIGGER if startStops was empty.
    ...
    private Map<String, Stop> loadAllStops() {
        ...
        try (
            ...
            while (rs.next()) {
                ...
                if (this.excludedStopIds.contains(stopId)) {
                    debug("Excluding stop based on exclusion list: " + stopId);
                    continue;
                }
