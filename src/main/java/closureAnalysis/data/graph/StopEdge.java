...
public class StopEdge {
    ...
    public boolean equals(Object o) {
        ...
        return (Objects.equals(node2.getId(), stopEdge.node2.getId()) &&
                Objects.equals(node1.getId(), stopEdge.node1.getId())) ||
                (Objects.equals(node2.getId(), stopEdge.node1.getId()) &&
                        Objects.equals(node1.getId(), stopEdge.node2.getId()));
    }

    @Override
    public int hashCode() {
        return Objects.hash(node1.getId(), node2.getId()) +
                Objects.hash(node2.getId(), node1.getId());
    }
}
